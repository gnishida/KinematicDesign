...
namespace kinematics {
	...
	public:
		...
		Solution(const std::vector<glm::dvec2>& points, double pose_error, double orientation_error, double dist, const std::vector<std::vector<glm::dmat3x3>>& poses, const std::vector<std::vector<int>>& zorder);
	};
