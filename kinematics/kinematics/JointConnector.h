...
namespace kinematics {
	...
	public:
		...
		QMap<int, std::vector<int>> collisions1;	// store all the indices of connectors that this connector collide
													// key of map is the joint id, and value is the list of connect ids
		QMap<int, bool> collisions2;	// store all the indices of connectors that this connector collide
