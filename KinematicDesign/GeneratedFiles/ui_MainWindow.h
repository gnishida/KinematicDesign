...
public:
    ...
    void setupUi(QMainWindow *MainWindowClass)
    {
        ...
        QIcon icon15;
        icon15.addFile(QStringLiteral("Resources/options.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon16;
        icon16.addFile(QStringLiteral("Resources/moving_rectangle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionMovingRectangle->setIcon(icon16);
        ...
        QIcon icon17;
        icon17.addFile(QStringLiteral("Resources/moving_circle.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionMovingCircle->setIcon(icon17);
        ...
        QIcon icon18;
        icon18.addFile(QStringLiteral("Resources/moving_polygon.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionMovingPolygon->setIcon(icon18);
        ...
        QIcon icon19;
        icon19.addFile(QStringLiteral("Resources/linkage_avoidance.png"), QSize(), QIcon::Normal, QIcon::Off);
